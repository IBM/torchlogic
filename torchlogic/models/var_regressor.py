...
class VarNRNRegressor(BaseVarNRNModel, ReasoningNetworkRegressorMixin):
    ...
    def __init__(
        ...
        """
        ReasoningNetworkRegressorMixin.__init__(self, output_size=output_size)
